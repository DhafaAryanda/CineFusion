...
<head>
    ...
    <title>CineFusion | @yield('title')</title>
    ...
    <script src="{{ assets('cinefusion/assets/script/tailwind-config.js') }}"></script>
...
<body class="bg-stream-dark font-poppins">
    ...
    <script src="{{ assets('cinefusion/assets/script/script.js') }}"></script>
