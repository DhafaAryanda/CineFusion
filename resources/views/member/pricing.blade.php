...
<body class="bg-stream-dark">
    ...
    <div class="relative">
        <div class="hidden lg:block fixed">
            <img src="{{ asset('cinefusion/assets/images/banner.png') }}" class="max-h-screen" alt="stream" />
        </div>
    </div>
    <div class="grid md:grid-cols-12 font-poppins relative pb-20">
        ...
        <span class="fixed -z-10 top-0">
            <img src="{{ asset('cinefusion/assets/images/pricing_ornament.svg') }}" class="h-screen w-screen" alt="stream" />
        </span>
        <!-- ./ -->
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <img src="{{ asset('cinefusion/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
