...
<div class="flex gap-14 items-start">
    <a href="{{ route('member.dashboard') }}">
        <img src="{{asset ('cinefusion/assets/images/ic_arrow-left-normal.svg') }}" alt="">
    </a>
    <div class="flex flex-col gap-10">
        ...
        <div class="w-full relative overflow-hidden group">
            ...
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                <img src="{{asset ('cinefusion/assets/images/ic_play.svg') }}" width="80" alt="">
            </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="inline-flex items-center gap-[6px]">
                <img src="{{asset ('cinefusion/assets/images/ic_star.svg') }}" alt="">
                <img src="{{asset ('cinefusion/assets/images/ic_star.svg') }}" alt="">
                <img src="{{asset ('cinefusion/assets/images/ic_star.svg') }}" alt="">
                <img src="{{asset ('cinefusion/assets/images/ic_star.svg') }}" alt="">
                <img src="{{asset ('cinefusion/assets/images/ic_star.svg') }}" alt="">
