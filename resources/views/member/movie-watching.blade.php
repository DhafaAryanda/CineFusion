...
<body>
    ...
    <section class="mx-auto w-screen relative watching-page font-poppins" id="stream">
        ...
        <div class="absolute top-5 left-5 z-20">
            <a href="{{ route('member.movie.detail', $movie->id) }}">
                <img src="{{ asset('cinefusion/assets/images/ic_arrow-left.svg') }}" class="transition-all btn-back w-[46px]" alt="stream" />
            </a>
        </div>
    ...
    <script>
        ...
        videojs('stream-video', {
            ...
            autoplay: true,
            preload: 'auto',
            poster: "{{ asset('cinefusion/assets/images/poster.png') }}",
