...
<div class="flex items-center gap-3">
    <img src="{{ asset('cinefusion/assets/images/ic_subscription.svg') }}" alt="">
...
<div class="flex flex-col gap-6 font-medium text-base text-white -mt-[10px] px-[18px]">
    <div class="flex gap-4 items-center">
        <img src="{{ asset('cinefusion/assets/images/ic_check-dark.svg') }}" alt="">
...
<div class="rounded-2xl bg-[#19152E] p-[30px] w-max">
    ...
    <form action="{{ route('member.user_premium.destroy', $user_premium->id) }}" method="POST">
        @csrf
        @method('DELETE')
