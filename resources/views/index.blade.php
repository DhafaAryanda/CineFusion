...
<head>
    ...
    <script src="{{ asset('cinefusion/assets/script/tailwind-config.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('cinefusion/assets/css/videojs.css') }}">
...
<body>
    ...
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        <img src="{{ asset('cinefusion/assets/images/green_radial.svg') }}" class="absolute" alt="stream" />
        <img src="{{ asset('cinefusion/assets/images/red_radial.svg') }}" class="absolute right-0" alt="stream" />
        ...
        <nav class="container py-5 relative">
            <div class="flex flex-col w-full lg:flex-row lg:items-center">
                ...
                <div class="flex items-center justify-between block lg:hidden">
                    <!-- LOGO -->
                    <a href="/index.html">
                        <img src="{{ asset('cinefusion/assets/images/stream.svg" alt="stream') }}" />
                    </a>
        ...
        <section class="px-4 relative max-w-[950px] overflow-hidden mx-auto" id="stream">
            ...
            <div class="w-full relative flex">
                <img src="{{ asset('cinefusion/assets/images/temp_img.png') }}" class="object-cover rounded-[50px]" alt="stream" />
                <button class="absolute z-10 top-[50%] left-[50%] -mt-[25px] -ml-[25px] md:-mt-[44px] md:-ml-[44px]
                    cursor-pointer" id="stream-preview">
                    <img src="{{ asset('cinefusion/assets/images/ic_play.svg') }}" class="w-8/12 md:w-full" alt="stream" />
                </button>
            </div>
        </section>
        ...
        <section class="brands pb-[100px] pt-[50px] flex flex-wrap justify-center items-center gap-x-[70px] gap-y-10 px-2
            relative">
            <img src="{{ asset('cinefusion/assets/images/logo-apple-tv.svg') }}" alt="stream" />
            <img src="{{ asset('cinefusion/assets/images/logo-ipad-apple.svg') }}" alt="stream" />
            <img src="{{ asset('cinefusion/assets/images/logo-android-wordmark.svg') }}" alt="stream" />
            <img src="{{ asset('cinefusion/assets/images/logo-youtube-tv.svg') }}" alt="stream" />
        </section>
    </header>

    <script src="https://code.jquery.com/jquery-3.6.0.min.js"
        integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    <script src="{{ asset('cinefusion/assets/script/script.js') }}"></script>
